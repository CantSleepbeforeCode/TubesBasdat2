        ...
        <div class="app-main">
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="lap-mentoring.php" class="mm-active">
                                        <i class="metismenu-icon pe-7s-display1"></i>Mentoring
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <!-- laporan absen mentoring -->
                        <div class="row" style="margin-bottom:2rem">
                            <?php
                                $urut = 1;
                                $data = mysqli_query($connect,"SELECT * FROM view_absen_mentoring WHERE id_mentorr = 'M0007' AND isVerified = 'verified'");
                            ?>
                            <div class="col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header-tab card-header-tab-animation card-header">
                                        <h5 class="card-title">Laporan Absen Mentoring</h5>
                                    </div>
                                    <div class="card-body">

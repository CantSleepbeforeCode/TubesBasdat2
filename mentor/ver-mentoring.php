                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="ver-mentoring.php" class="mm-active">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header-tab card-header-tab-animation card-header">
                                        <h5 class="card-title">Verifikasi Absen Mentoring</h5>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <table id="mentoring" class="mb-0 table table-borderless">
                                            ...
                                            <?php foreach ($data as $row) {
                                                ...
                                                <td><a class="btn btn-danger" href="crud/reject-mentoring.php?id='.$row['id_absensi'].'">Tolak</a></td>

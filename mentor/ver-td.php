                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="ver-td.php" class="mm-active">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header-tab card-header-tab-animation card-header">
                                        <h5 class="card-title">Verifikasi Absen Talent Development</h5>
                                    </div>
                                    <div class="card-body">
                                        
                                        <table id="tbl-ver-td" class="mb-0 table table-borderless">
                                            <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nama</th>
